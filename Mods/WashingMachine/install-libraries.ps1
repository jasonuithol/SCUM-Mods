...
<#
.SYNOPSIS
  Downloads WashingMachine's runtime dependencies into this folder.
...
function Install-Dependency {
    ...
    $tmpDir = Join-Path $env:TEMP ('wm_dl_' + [guid]::NewGuid().ToString('N'))
...
Write-Host 'WashingMachine - installing runtime libraries into:'
Write-Host ("  {0}" -f $Here)
