...
<#
.SYNOPSIS
  Downloads FlagUpkeep's runtime dependencies into this folder.
...
function Install-Dependency {
    ...
    $tmpDir = Join-Path $env:TEMP ('fu_dl_' + [guid]::NewGuid().ToString('N'))
...
Write-Host 'FlagUpkeep - installing runtime libraries into:'
Write-Host ("  {0}" -f $Here)
